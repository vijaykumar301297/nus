  ...
  <div class="main">
    ...
    <div>
            ...
            <form id="regForm" action="insertsupplycontract.php?type=adding" method="POST">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div style="display: inline-block;">
                      <div class="cat action">
                        <label>
                          <input type="checkbox" value="electricity" name="commodity[]" class="commodity" checked><span class="disabledbutton act"><img src="img/electricity-hover.svg">Electricity</span>
                        </label>
                      </div>
                      <div class="cat action">
                        <label>
                          <input type="checkbox" value="natural gas" name="commodity[]" class="commodity"><span class="disabledbutton dis"><img src="img/naturalgas.svg"> Natural Gas</span>
                        </label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 units">
                    ...
                    <div class="natru" style="display: inline-block;">
                      <div class="cat action">
                        <label>
                          <input type="checkbox" value="MWh" name="units[]" class="unit" checked><span class="disabledbutton dis">MWh</span>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div style="display: inline-block;">
                      <div class="cat action">
                        <label>
                          <input type="checkbox" value="fixed" name="contacttype[]" class="contactType" checked><span class="disabledbutton dis">Fixed</span>
                        </label>
                      </div>
                      <div class="cat action">
                        <label>
                          <input type="checkbox" class="contactType" name="contacttype[]" value="indexed"><span class="disabledbutton dis">Indexed</span>
                        </label>
                      </div>
                    </div>
                  </div>
              ...
              <div class="tab" id="length">
                ...
                <div class="input-group input-daterange">
                  <input id="startDate1" name="startDate1" type="text" class="form-control startdate" onchange="calcualteMonthYr(this.value,$('.endate').val())" readonly="readonly"> <span class="input-group-addon">
                    <!--  <span
                    class="glyphicon glyphicon-calendar"></span> -->
                  </span> <span class="input-group-addon">to</span> <input id="endDate1" name="endDate1" type="text" class="form-control endate" readonly="readonly" onchange="calcualteMonthYr($('.startdate').val(), this.value)">
                ...
                <script type="text/javascript">
                  function FormatCurrency(ctrl) {
                    console.log("Well here" + ctrl.value);
                    var num = ctrl.value;
              ...
              <div class="tab indexdex" id="index">
                ...
                <div style="display: inline-block;">
                  <div class="cat action">
                    <label>
                      <input type="checkbox" class="indexstr" name="indexstr[]" value="Consumption(MWh)" id="cconsumption" checked><span class="disabledbutton dis">Consumption(MWh)</span>
                    </label>
                  </div>
                  <div class="cat action naturalGass" id="naturalgas">
                    <label>
                      <input type="checkbox" class="indexstr" name="indexstr[]" value="Power(MW)" id="cpower"><span class="disabledbutton">Power(MW)</span>
                    </label>
                  </div>
                </div>
      ...
      <script>
          ...
          if (type == 'next') {
            ...
            if (currentTab == 1) {
              ...
              if (contractType == 'fixed') {
                ...
                printtwodata += '<td>' + parsedObject.comodityprice + ' per MWh</td>';
                printtwodata += '</tr>';
            ...
            if (currentTab == 2) {
              ...
              console.log("Yoyo == " + $('.indexstr:checked').val());
        ...
        const checkBoxes = document.querySelectorAll('input[type="checkbox"].indexstr');
        ...
        var vals;
        $('.indexstr').on('change', function() {
          vals = $('.indexstr:checked').val();
        });

        function addTradeperiods() {
          console.log("Vals = " + vals);
          if (vals == 'Power(MW)') {
            $('#cconsumption').attr('disabled', true);
          } else {
            $('#cpower').attr('disabled', true);
          }

          var rowcount = parseInt($('.rowcount').val());

          console.log("Value == " + $('.indexstr:checked').val());
          ...
          if (rocount.length == list.length) {
            alert('No more allowable trade clicks!');
            location.href = 'addsupplycontract.php';
            return;
          }
          ...
          if ($('.indexstr:checked').val() == 'Power(MW)') {
            console.log($('.indexstr:checked').val());
            ...
            printData += '</div>';
            printData += '<div class="col-md-4">';
            printData += '<input type="number" pattern=" 0+\.[0-9]*[1-9][0-9]*$" onkeypress="return event.charCode >= 48 && event.charCode <= 57" style="margin: 0 0 0 -44%;" class="form-control tranche' + rowcount + '" name="tranche' + rowcount + '">';
            printData += '</div>';
