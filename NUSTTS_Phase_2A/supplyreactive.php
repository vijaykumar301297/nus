...
<head>
    ...
    <title>NUS TTS System | Re-active Supply Company</title>
    ...
    <section class="sec1Container">
        <div class="sec1Wrapper">
            <div class="archievecontainer">
                <h2>Reactivate <?php echo base64_decode($_GET['contractname']);?></h2>
                <div class="close-btn"onclick='location.href="addhome.php";';>&times;</div>
                <hr color="#d2ddec">
                <form action="postsupplyarchieve.php" method="POST" class="archieveform">
                    <!-- <label for="" hidden>Parent Company</label> -->
                    
                    <input autocomplete="off" type="text" name="clientId"  value="<?php echo $_GET['info']?>"   hidden>
                    <input autocomplete="off" type="text" name="supplierId"  value="<?php echo $_GET['id']?>"   hidden>    
                    <input autocomplete="off" type="text" name="contract_id"  value="<?php echo $_GET['contractname']?>"   hidden>    
