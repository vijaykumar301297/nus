...
include ('dbconn.php');
$sql = "select * from clientarchieve where clientcompany = '".base64_decode($_GET['clinet'])."'";
// echo $sql;
...
<body>
    <div class="container">
        ...
        <div>
            ...
            <h3>List of state modification made in <strong><?php echo base64_decode($_GET['clinet'])?></strong></h3>
