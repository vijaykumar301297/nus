...
<body>
    ...
    <div class="containertrade">
        <form action="postgraphss.php" method="POST" autocomplete="off" onsubmit="return validForm()">
            <div class="header">
            ...
            <div class="contents">
                <div class="clientDetails">
                    <label class="clientData">Parent</label>
                        <select  id="client" name="parentid" onchange="parentdetails(this.value)">
        ...
        <div class="reportdetails international">
         ...
         <div class="clientDetails">
                    <label class="clientDatas">Parent</label>
                        <select  id="parentT" name="parentid" onchange="parentdetails(this.value)">
                            <option value="">Select Parent</option>
