...
$usernames = $_POST["emailId"];
// $newpassword = $_POST["newpassword"];
// $password = $_POST["confirmpassword"];

$sql1 = "SELECT * FROM nususerdata WHERE emailId='".$usernames."';";
$result1 = $conn->query($sql1);

if($result1->num_rows == 0) {
    echo "<script>
    alert('User Records Not Found!');
    location.href='signin.php';
</script>";
die();
}
    $usernamed = mysqli_fetch_assoc($result1);
    $username = $usernamed['username'];



    $encodedUser = base64_encode($username);
    $resVar = base64_encode("yes");
    ...
    //  $mail->Subject = "NUS TTS User Password Reset";
...
<body bgcolor="#F8F8F8" lang="EN-US" link="blue" vlink="purple" style="word-wrap:break-word">
                                                 ...
                                                 <td valign="top" style="padding:0in 0in 0in 0in">
                                                     ...
                                                     <p
                                                         ...
                                                         <span
                                                             ...
                                                             You have requested to reset your password in NUS Consulting Group&#39s TTS System. Please click the button below to confirm your e-mail address and complete the creation of your new password.
                                                             <o:p></o:p>
                                                         </span>
                                                     </p>
                                                     <table class="MsoNormalTable" border="0" cellspacing="0"
 ...
 ';
     ...
     if($mail->Send()) {
        ...
        echo "<script>;
            alert('Password reset mail has been Sent succesfully!'); 
            window.location = 'signin.php';
        </script>";
        // header('location:table.php');
     } else {
         echo "<script>;
            alert('Could not able to send email! Please try agin after some time!'); 
            window.location = 'signin.php';
        </script>";
     }
