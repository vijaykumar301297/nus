...
$getsupplydetails = "SELECT * FROM clientcompanydata WHERE id=".$_GET['id']."";
...
<head>
    ...
    <title>NUS TTS System | Edit Client Company</title>
    ...
    <section class="sec1Container">
        <div class="sec1Wrapper">
            <div class="clientContainer">
                ...
                <hr color="#d2ddec">
                <form action="postclientedit.php" method="POST" class="clientAddForm">
                    ...
                    <input type="text" name="clientcompany" id="cCompany" placeholder="Enter the client company's name" onkeyup="isEmpty()" value = "<?=$editsingledata[0]['clientcompany']?>" required >
                    <label for="pCompany">Parent Company</label>
                    <select name="parentcompany" id="pCompany" required>
                    <option onkeyup="isEmpty()" value = "<?=$editsingledata[0]['parentcompany']?>"><?=$editsingledata[0]['parentcompany']?></option>
                    <?php
                    ...
                    <select name="country" id="country" class="clientSelLast" required>
                        <option onkeyup="isEmpty()" value = "<?=$editsingledata[0]['country']?>"><?=$editsingledata[0]['country']?></option>
