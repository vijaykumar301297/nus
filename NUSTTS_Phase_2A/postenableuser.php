<?php
    ...
    include 'dbconn.php';
        ...
        $sql = "UPDATE nususerdata SET active ='".$verifyuserstatus."', password= '', accountstatus = 'Invited', created_time = '".$date."' WHERE emailId='".$emailid."'";
        $conn->query($sql);

        // echo $today();

        $sql1 = "SELECT * FROM nususerdata WHERE emailId='".$emailid."'";
