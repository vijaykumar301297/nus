...
<head>
    ...
    <title>NUS TTS System | Re-Active Client Company</title>
    ...
    <section class="sec1Container">
        <div class="sec1Wrapper">
            <div class="archievecontainer">
                <h2>Reactivate <?php echo base64_decode($_GET['clinet'])?> </h2>
                <div class="close-btn"onclick='location.href="addhome.php";';>&times;</div>
                <hr color="#d2ddec">
                <form action="postclientarchieve.php" method="POST" class="archieveform">
                    <!-- <label for="" hidden>Parent Company</label> -->
                    
                    <input autocomplete="off" type="text" name="id"  value="<?php echo $_GET['id']?>"   hidden>
                    <input autocomplete="off" type="text" name="clientcompany"  value="<?php echo base64_decode($_GET['clinet'])?>"   hidden>
                    <input autocomplete="off" type="text" name="parentcompany"  value="<?php echo base64_decode($_GET['parent'])?>"   hidden>                    

                    <label for="">Date</label>
                    <input type="date" id="date" name="datevalue" readonly>
                    <label for="">Type</label>
                    <input type="text" name="state" id="" value="Re-Active" readonly>
